...
archive = 'asteroid.zip'
z = ZipFile(archive)
list_file = [text_file.filename for text_file in z.infolist()] #Список названий разархивированных файлов

with ZipFile(archive, 'r') as zip_file:
    zip_file.extractall()

file_name_csv = list_file[0]
...
df_optimized.to_csv("dataset_optimizired.csv")

#!!!!!!!
memory_stat_dataset(df_original, file_name_csv,  "memory_info_data_orijinal.json")
#!!!!!!!
memory_stat_dataset(df_optimized, "dataset_optimizired.csv",  "memory_info_data_optimizired.json")
...
columns_name = ["full_name", "class", "neo", "pha", "name", "spkid",
             "H", "diameter", "albedo", "epoch"]
